...
from functions.responseFromKGTool import query_vector_rag
from functions.config import search_engine,load_neo4j_graph
import json
...
def get_vector_response(question,top_k=5):
    ...
    Vector_RAG = query_vector_rag(question=question)
    return Vector_RAG
