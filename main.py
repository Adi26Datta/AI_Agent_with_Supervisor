...
from functions.agents import Search_Agent, KG_Agent, Supervisor_Agent
...
@st.cache_resource
def get_supervisor():
    return Supervisor_Agent(search_agent=Search_Agent(),
        knowledgeGraph_agent=KG_Agent()).compile()
